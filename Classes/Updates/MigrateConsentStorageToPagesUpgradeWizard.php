...
namespace OliverKroener\OkPriveConsent\Updates;
 ...
 *
 * Up to version 4.1.1 the banner script and the enable flag were stored on the
 * sys_template record of the site root page. Sites driven by site sets (TYPO3 13.1+)
 * have no sys_template record at all, so the settings now live on the pages record
 * of the site root.
 */
