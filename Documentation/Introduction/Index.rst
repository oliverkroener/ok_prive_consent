...
and no site set have to be configured.
...
-  **Automatic frontend rendering** -- script and cookie settings button injected
   before ``</body>`` by a PSR-14 event listener, no TypoScript required
-  **Site set** (TYPO3 13.1+) -- selectable under *Site Management > Sites*;
   optional, the banner works without it
